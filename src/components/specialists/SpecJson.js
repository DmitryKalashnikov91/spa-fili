...
export const SpecJSON = [
	...
	},
	{
		...
		urlImg: Dmitry,
		content:
			'Опыт 7 лет. Классический, Спортивный, Расслабляющий, Антицеллюлитный, Лимфодренажный, Точечный, Баночный, Французский моделирующий, Испанский масляный, Балийский, Суставной, Миофасциальный, Перкуссионный, Сегментарно-рефлекторный, Хиро',
	},
	{
		id: nanoid(6),
		name: 'Мария',
