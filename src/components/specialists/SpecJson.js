...
export const SpecJSON = [
	...
	},
	{
		...
		urlImg: Elena,
		content:
			'Опыт 5,5 лет, все виды ручного массажа: Классический, Релакс,  Лимфодренажный, Спортивный, Антицеллюлитный, Коррекция фигуры (Медовый, Солевой), Массаж лица (классика, скульптурный), Баночный.',
	},
]
